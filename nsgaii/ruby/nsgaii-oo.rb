...
class NSGAII
  ...
  attr_reader :p_cross
  attr_reader :bits_per_param
  attr_reader :pop
  attr_reader :children
  attr_reader :bitstring

  def initialize(_search_space: search_space, _max_gens: max_gens, _pop_size: pop_size, _p_cross: p_cross, _bits_per_param: 16)
    puts "init"
    @search_space = _search_space
    @max_gens = _max_gens
    @pop_size = _pop_size
    @p_cross = _p_cross
    @bits_per_param = _bits_per_param
...
if __FILE__ == $0
  ...
  algo = NSGAII.new(_search_space: search_space, _max_gens: max_gens, _pop_size: pop_size, _p_cross: p_cross)
  puts "max_gens: #{max_gens}"
  max_gens.times do |i|
